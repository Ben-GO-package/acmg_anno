...
func initAcmg2015() {
	if *acmg {
		...
		acmg2015.Init(acmgCfg, *autoPVS1, *runPM1) // 使用处理后的配置初始化ACMG模块
	}
}
...
func annotate1(item map[string]string) {
	...
	// ues acmg of go
	if *acmg {
		acmg2015.AddEvidences(item, *autoPVS1, *runPM1)
		item["automated_judgment"] = acmg2015.PredACMG2015(item, *autoPVS1, *runPM1)
	}
